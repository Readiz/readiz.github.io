import{p as h}from"./This_is_Linux_-33dc9552.js";import{u as d,j as l,a as i,F as s}from"./ssg-client-a408e234.js";import{H as o}from"./Header-39b93b93.js";import{C as t}from"./Comment-8a5b5d83.js";import{T as a}from"./TagList-19c2c12d.js";import"./index.module-5d0c9a7d.js";function r(e){const n=Object.assign({h1:"h1",ul:"ul",li:"li",h2:"h2",h3:"h3",pre:"pre",code:"code",p:"p",a:"a"},d(),e.components);return i(s,{children:[l(o,{}),`
...
`,l(n.pre,{children:l(n.code,{className:"language-bash",children:`readiz@Readiz-NotePC:~$ which bash\r
/usr/bin/bash\r
readiz@Readiz-NotePC:~$ which systemd\r
/usr/bin/systemd
`})}),`
`]}),`
`]}),`
...
`,l(n.li,{children:`usr 밑의 bin, lib,… 등은 사용자가 자유롭게 다룰 수 있으 며 루트 디렉토리의 같은 이름을 가진 디렉토리와 같은 역할\r
을 한다. (대신 우선순위가 떨어진다.)`}),`
...
`,l(n.pre,{children:l(n.code,{className:"language-text",children:`Filesystem      1K-blocks       Used  Available Use% Mounted on\r
/dev/sdb        263174212    5290692  244445364   3% /\r
tools           249105148  164725580   84379568  67% /init\r
none              6509908          0    6509908   0% /dev\r
tmpfs             6512308          0    6512308   0% /sys/fs/cgroup\r
none              6512308         16    6512292   1% /run\r
...
`,l(n.li,{children:`Linear RAID는 그나마 차례로 쓰기 때문에 (성능은 낮지만) 하드 손상 시 다른 데이터들은 멀쩡하지만,\r
RAID 0의 경우 파일 부분부분 모두 손상되기 때문에 사실상 복구의 가능성은 없다고 봐야 한다.\r
...
`,l(n.pre,{children:l(n.code,{className:"language-sh",children:`#!/bin/sh\r
echo "사용자 이름: " $USER\r
echo "홈 디렉터리: " $HOME\r
exit 0
`})}),`
...
num2=$num1+200\r
echo $num2\r
num3=\`expr $num1 + 200\`\r
echo $num3\r
num4=\`expr \\( $num1 + 200 \\) / 10 \\* 2\`\r
echo $num4\r
exit 0
`})}),`
`]}),`
...
`,i(n.ul,{children:[`
`,l(n.li,{children:"$0, $1, $2와 같은 녀석들임"}),`
...
`]}),`
`,l(n.pre,{children:l(n.code,{className:"language-bash",children:`#!/bin/sh\r
if [ "$1" = "" ]\r
then\r
  echo "인수를 입력하지 않았습니다."\r
else\r
  echo "인수를 입력하였습니다: " $1\r
fi\r
exit 0
`})}),`
`]}),`
...
`]}),`
`,l(n.pre,{children:l(n.code,{className:"language-bash",children:`readiz@Readiz-NotePC:/mnt/e/collected/selfdev/git/baekjoon/class/extra/20211127$ ps > pslog\r
readiz@Readiz-NotePC:/mnt/e/collected/selfdev/git/baekjoon/class/extra/20211127$ cat pslog\r
  PID TTY          TIME CMD\r
1339 pts/2    00:00:00 bash\r
...
`]}),`
`,l(a,{}),`
`,l(t,{})]})}function u(e={}){const{wrapper:n}=Object.assign({},d(),e.components);return n?l(n,Object.assign({},e,{children:l(r,e)})):r(e)}const m=Object.freeze(Object.defineProperty({__proto__:null,default:u},Symbol.toStringTag,{value:"Module"})),c={};c.outlineInfo=h;c.main=m;export{c as default};
