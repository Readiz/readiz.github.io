import{p as o}from"./LCA_-66b302c2.js";import{u as l,j as e,a as r,F as t}from"./ssg-client-a408e234.js";import{C as h}from"./Comment-8a5b5d83.js";import{T as p}from"./TagList-19c2c12d.js";import{H as a}from"./Header-39b93b93.js";import"./index.module-5d0c9a7d.js";function c(d){const n=Object.assign({p:"p",code:"code",h2:"h2",pre:"pre",h3:"h3"},l(),d.components);return r(t,{children:[e(a,{}),`
...
`,e(n.pre,{children:e(n.code,{className:"language-cpp",children:`for(Node* l = sl; l != 0; l = l->parent) {\r
    for(Node* r = sr; r != 0; r = r->parent) {\r
        if (l == r) return l;\r
    }\r
}
`})}),`
...
`,e(n.pre,{children:e(n.code,{className:"language-cpp",children:`if (l->depth < r->depth) swap(l, r);\r
while(l->depth > r->depth) l = l->parent;\r
for(;;l = l->parent, r = r->parent) {\r
    if (l == r) return l;\r
}
`})}),`
...
`,e(n.pre,{children:e(n.code,{className:"language-cpp",children:`struct Node {\r
    Node* parents[10]; // 최대 2^9의 부모를 저장한다.\r
};\r
Node* findParent(Node* cur, int num) {\r
    int mask = 0x1;\r
    for(int i = 0; i < 10; ++i, mask <<= 1) {\r
        if (num & mask) cur = cur->parents[i]; // 2의 지수승만큼의 부모로 이동한다.\r
    }\r
    return cur;\r
}
`})}),`
...
`,e(n.pre,{children:e(n.code,{className:"language-cpp",children:`if (l->depth < r->depth) swap(l, r);\r
int diff = l->depth - r->depth;\r
// 1. depth를 맞춰준다.\r
int mask = 0x1;\r
for(int i = 0; i < 10; ++i, mask <<= 1) {\r
    if (num & mask) l = l->parents[i]; // 2의 지수승만큼의 부모로 이동한다.\r
}\r
if (l == r) return l;\r
// 2. 같아지기 직전까지 올라간다.\r
for(int i = 10 - 1; i >= 0; --i) {\r
    Node* nl = l->parents[i];\r
    Node* nr = r->parents[i];\r
    if (nl == nr) continue;\r
    l = nl; r = nr;\r
}\r
while(l != r) {\r
...
`,e(n.pre,{children:e(n.code,{className:"language-cpp",children:`for(int i = 0; i < 10; ++i) {\r
    if (n->parents[i - 1] != nullptr)\r
        n->parents[i] = n->parents[i - 1]->parents[i - 1];\r
    else n->parents[i] = nullptr;\r
}
`})}),`
