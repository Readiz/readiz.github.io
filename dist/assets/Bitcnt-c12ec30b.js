import{p as a}from"./Bitcnt_-94819c75.js";import{r as F,a as i,F as c,j as r,u as d}from"./ssg-client-a408e234.js";import{C as h}from"./Comment-8a5b5d83.js";import{H as v}from"./Header-39b93b93.js";import{T as p}from"./TagList-19c2c12d.js";import"./index.module-5d0c9a7d.js";const u=e=>{const[n,s]=F.useState(!1);function o(){s(!n)}return i(c,{children:[r("div",{onClick:o,style:{fontWeight:700,cursor:"pointer"},children:n?"👆 닫기":"👉 펼치기"}),r("div",{style:{display:n?"block":"none"},children:e.children})]})};function t(e){const n=Object.assign({p:"p",code:"code",pre:"pre",h3:"h3",a:"a",h2:"h2"},d(),e.components);return i(c,{children:[r(v,{}),`
...
`,i(u,{children:[r(n.h3,{id:"32bit-test",children:"32bit Test"}),r(n.pre,{children:r(n.code,{className:"language-cpp",children:`#include <stdio.h>\r
#include <time.h>\r
\r
#define BITCNT(n,r) { \\\r
    n -= (n >> 1) & 0x5555555555555555; \\\r
...
`})})]}),`
`,r(p,{}),`
`,r(h,{})]})}function g(e={}){const{wrapper:n}=Object.assign({},d(),e.components);return n?r(n,Object.assign({},e,{children:r(t,e)})):t(e)}const m=Object.freeze(Object.defineProperty({__proto__:null,default:g},Symbol.toStringTag,{value:"Module"})),l={};l.outlineInfo=a;l.main=m;export{l as default};
