import{p as t}from"./LIS_-66345136.js";import{u as d,j as n,a as c,F as h}from"./ssg-client-a408e234.js";import{C as o}from"./Comment-8a5b5d83.js";import{T as a}from"./TagList-19c2c12d.js";import{H as s}from"./Header-39b93b93.js";import"./index.module-5d0c9a7d.js";function i(r){const e=Object.assign({p:"p",h2:"h2",code:"code",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",strong:"strong",pre:"pre"},d(),r.components);return c(h,{children:[n(s,{}),`
...
`,n(e.pre,{children:n(e.code,{className:"language-cpp",children:`if (A[i] < A[j])\r
    DP[j] = max(DP[j], DP[i] + 1);
`})}),`
`,c(e.p,{children:["여기서 ",n(e.code,{children:"j"}),"는 ",n(e.code,{children:"i"}),"보다 커야 한다. (증가하는 순서이므로) 루프를 포함한 전체 코드는 아래와 같다."]}),`
`,n(e.pre,{children:n(e.code,{className:"language-cpp",children:`DP[0] = 1; // 첫번째 원소는 무조건 1의 LIS를 가진다.\r
for(int j = 1; j < sz; ++j) { // j번째를 채울 때, [0, j)까지 확인해서 max 값을 사용한다.\r
    for(int i = 0; i < j; ++i) { // i < j\r
        if (A[i] < A[j]) \r
            DP[j] = max(DP[j], DP[i] + 1);\r
    }\r
}
`})}),`
...
`,n(e.pre,{children:n(e.code,{className:"language-cpp",children:`vector<int> DP;\r
for(int i = 0; i < sz; ++i) {\r
    auto it = lower_bound(DP.begin(), DP.end(), A[i]);\r
    if (it == DP.end()) {\r
        DP.push_back(A[i]);\r
    } else {\r
        *it = A[i];\r
...
`,n(a,{}),`
`,n(o,{})]})}function p(r={}){const{wrapper:e}=Object.assign({},d(),r.components);return e?n(e,Object.assign({},r,{children:n(i,r)})):i(r)}const g=Object.freeze(Object.defineProperty({__proto__:null,default:p},Symbol.toStringTag,{value:"Module"})),l={};l.outlineInfo=t;l.main=g;export{l as default};
