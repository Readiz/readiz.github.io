import{p as l}from"./Bitcnt_-c78f510e.js";import{u as r,j as i,a as e,F as s}from"./ssg-client-795f2479.js";import{C as o}from"./Comment-d85e0ca2.js";function c(t){const n=Object.assign({h1:"h1",p:"p",code:"code",h3:"h3",pre:"pre",a:"a",h2:"h2"},r(),t.components);return e(s,{children:[i(n.h1,{id:"bitcnt",children:"Bitcnt"}),`
`,e(n.p,{children:["흔히 ",i(n.code,{children:"__builtin_popcount"}),"로 사용하지만, 직접 구현할 경우를 살펴본다."]}),`
`,e(n.p,{children:[i(n.code,{children:"__builtin_popcount"}),"란 gcc 내장 함수로, 아래와 같이 사용한다. (VS에서는 아쉽지만 사용이 불가하다, 유사한건 있지만..)"]}),`
`,i(n.p,{children:i(n.code,{children:"__builtin_popcount(v)"})}),`
`,e(n.p,{children:["여기서 ",i(n.code,{children:"v"}),"는 int 형을 사용한다. 만약 64bit의 bitcnt가 필요하다면, 뒤에 ll이 붙은 ",i(n.code,{children:"__builtin_popcountll"}),"을 사용한다."]}),`
...
`,e("details",{children:[i(n.h3,{id:"32bit-test",children:"32bit Test"}),i(n.pre,{children:i(n.code,{className:"language-cpp",children:`#include <stdio.h>
#include <time.h>
...
`})})]}),`
`,i(o,{})]})}function a(t={}){const{wrapper:n}=Object.assign({},r(),t.components);return n?i(n,Object.assign({},t,{children:i(c,t)})):c(t)}const F=Object.freeze(Object.defineProperty({__proto__:null,default:a},Symbol.toStringTag,{value:"Module"})),d={};d.outlineInfo=l;d.main=F;export{d as default};
