import{p as a}from"./Bitcnt_-94819c75.js";import{r as F,a as e,F as r,j as i,u as d}from"./ssg-client-264fa950.js";import{C as h}from"./Comment-a4e33415.js";import{H as v}from"./Header-33a924c3.js";import{T as p}from"./TagList-d2de30d1.js";import"./index.module-caf545e8.js";const u=t=>{const[n,s]=F.useState(!1);function o(){s(!n)}return e(r,{children:[i("div",{onClick:o,style:{fontWeight:700,cursor:"pointer"},children:n?"👆 닫기":"👉 펼치기"}),i("div",{style:{display:n?"block":"none"},children:t.children})]})};function c(t){const n=Object.assign({p:"p",code:"code",pre:"pre",h3:"h3",a:"a",h2:"h2"},d(),t.components);return e(r,{children:[i(v,{}),`
