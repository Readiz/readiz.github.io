import{p as r}from"./Heap_-7c5537af.js";import{u as o,j as d,a as i,F as s}from"./ssg-client-5b6a3a34.js";import{C as l}from"./Comment-0bb48b2d.js";import{T as a}from"./TagList-b1d77288.js";import{H as t}from"./Header-976c6ade.js";import"./index.module-caf545e8.js";function c(e){const n=Object.assign({p:"p",code:"code",h2:"h2",ul:"ul",li:"li",pre:"pre"},o(),e.components);return i(s,{children:[d(t,{}),`
...
`,i(n.p,{children:["이게 좀 어렵다. 우선, 1번 ",d(n.code,{children:"index"}),"의 데이터가 빠져나간다. 그리고 나서 swap이 시작될 텐데, 일단 이 때의 target은 ",d(n.code,{children:"sz - 1"})," 위치에 있는 아이템이 될 것이다. 먼저 좌측 자식으로 swap 한다고 생각한 이후, 우측 자식의 조건이 더 좋으면 우측 자식하고 swap 한다."]}),`
`,d(n.pre,{children:d(n.code,{className:"language-cpp",children:`T d[SZ + 1];
int sz;
...
`,i(n.p,{children:["Heap에 삽입된 시점의 ",d(n.code,{children:"Index"}),"를 저장해주면, 특정 원소의 값을 찾을 수 있고, 그 ",d(n.code,{children:"Index"}),"의 값을 변경할 수 있다. 변경 후에는 ",d(n.code,{children:"swim"}),"과 ",d(n.code,{children:"sink"}),"를 순서 관계없이 1번씩 해주면 다시 heap의 구조가 유지된다. 이를 활용한 전체 heap 코드의 샘플은 아래와 같다."]}),`
