import{p as h}from"./BinarySearch_-6fc24b23.js";import{u as l,j as e,a as r,F as o}from"./ssg-client-cfb40af0.js";import{C as t}from"./Comment-d481f3fa.js";import{T as a}from"./TagList-f9bb2af7.js";import{H as p}from"./Header-2dfda0ee.js";import"./index.module-caf545e8.js";function i(d){const n=Object.assign({p:"p",code:"code",h1:"h1",h2:"h2",pre:"pre",ol:"ol",li:"li",ul:"ul",h3:"h3",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",strong:"strong"},l(),d.components);return r(o,{children:[e(p,{}),`
...
`,r(n.p,{children:["간단히 하기 위해서 구간은 [s, e]로 통일하는 것이 좋다. 다만, ",e(n.code,{children:"lower_bound"}),", ",e(n.code,{children:"upper_bound"}),"의 구현 시 결과가 ",e(n.code,{children:"e+1"}),"이 나올 수 있는데, 이 경우는 구간내에 값보다 큰 값이 왔을 경우이다."]}),`
...
int upperBound(int arr[], int s, int e, int tval) {
    ...
    while (l <= r) {
        mid = (l + r) >> 1;
        if (tval == arr[mid]) {
            l = mid + 1; // 여기가 바뀐다. 더 큰걸 찾는 거니까 우측으로 계속해서 보면 된다. (lowerBound는 경계값에서 좌측, upper는 우측)
        }
        else if (tval < arr[mid]) {
            ans = mid; // lowerBound 구현 대비 달라지는 부분
            r = mid - 1;
        } else {
            l = mid + 1;
        }
...
`,e(a,{}),`
`,e(t,{})]})}function s(d={}){const{wrapper:n}=Object.assign({},l(),d.components);return n?e(n,Object.assign({},d,{children:e(i,d)})):i(d)}const u=Object.freeze(Object.defineProperty({__proto__:null,default:s},Symbol.toStringTag,{value:"Module"})),c={};c.outlineInfo=h;c.main=u;export{c as default};
