import{p as r}from"./Heap_-416b9bce.js";import{u as c,j as d,a as e,F as s}from"./ssg-client-1ba56467.js";import{C as l}from"./Comment-577e71cc.js";import{T as a}from"./TagList-20f50a5a.js";import{H as t}from"./Header-78a29a32.js";import"./index.module-caf545e8.js";function o(i){const n=Object.assign({p:"p",code:"code",h2:"h2",ul:"ul",li:"li",pre:"pre"},c(),i.components);return e(s,{children:[d(t,{}),`
...
`,e(n.p,{children:["이게 좀 어렵다. 우선, 1번 ",d(n.code,{children:"index"}),"의 데이터가 빠져나간다. 그리고 나서 swap이 시작될 텐데, 일단 이 떄의 target은 ",d(n.code,{children:"sz - 1"})," 위치에 있는 아이템이 될 것이다. 먼저 좌측 자식으로 swap 한다고 생각한 이후, 우측 자식의 조건이 더 좋으면 우측 자식하고 swap 한다."]}),`
`,d(n.pre,{children:d(n.code,{className:"language-cpp",children:`T d[SZ + 1];
int sz;
...
`,e(n.p,{children:["Heap에 삽입된 시점의 ",d(n.code,{children:"Index"}),"를 저장해주면, 특정 원소의 값을 찾을 수 있고, 그 ",d(n.code,{children:"Index"}),"의 값을 변경할 수 있다. 변경 후에는 ",d(n.code,{children:"swim"}),"과 ",d(n.code,{children:"sink"}),"를 순서 관계없이 1번씩 해주면 다시 heap의 구조가 유지된다. 이를 활용한 전체 heap 코드의 샘플은 아래와 같다."]}),`
