import{p as a}from"./PBDS Set_-1dcd4a86.js";import{u as c,j as e,a as i,F as s}from"./ssg-client-a84c9b7f.js";import{C as l}from"./Comment-7f989ffb.js";import{T as o}from"./TagList-d587a9ba.js";import{H as h}from"./Header-c09ea125.js";import"./katex.min-4ed993c7.js";import"./index.module-caf545e8.js";function t(r){const n=Object.assign({p:"p",code:"code",ul:"ul",li:"li",a:"a",h2:"h2",h3:"h3",span:"span",math:"math",semantics:"semantics",mrow:"mrow",mi:"mi",mo:"mo",annotation:"annotation",pre:"pre"},c(),r.components);return i(s,{children:[e(h,{}),`
...
`,i(n.p,{children:["PBDS는 Policy based data structures의 약자로, ",e(n.code,{children:"g++"}),"에서 ",e(n.code,{children:"ext/pb_ds"})," 아래에 위치하는 데이터 구조를 칭한다. (MSVC에서는 사용이 어려울 듯) 보통 ",e(n.code,{children:"PS"}),"에서 이것을 사용하는 의의 중 하나는 기존 ",e(n.code,{children:"STL Set"}),"에서 지원하지 않는 ",e(n.code,{children:"K"}),"번째 크기가 큰(또는 작은) 원소를 빠르게 찾을 수 있게 하는 데이터 구조를 사용하기 위해 사용하는 것이다."]}),`
