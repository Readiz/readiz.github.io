import{p as o}from"./LCA_-66b302c2.js";import{u as l,j as e,a as r,F as t}from"./ssg-client-6b9b38a2.js";import{C as h}from"./Comment-c61b5d7d.js";import{T as p}from"./TagList-ab9d9516.js";import{H as a}from"./Header-d5cd2f1f.js";import"./index.module-caf545e8.js";function c(d){const n=Object.assign({p:"p",code:"code",h2:"h2",pre:"pre",h3:"h3"},l(),d.components);return r(t,{children:[e(a,{}),`
...
`,r(n.p,{children:["만약 ",e(n.code,{children:"depth"}),"를 안다면, ",e(n.code,{children:"l"}),"과 ",e(n.code,{children:"r"}),"의 ",e(n.code,{children:"depth"}),"를 같게 맞춘 이후에, 양쪽 ",e(n.code,{children:"Node"}),"를 만날 떄까지 같이 올리면 된다. 구현의 편의를 위해 처음에는 무조건 ",e(n.code,{children:"l"}),"의 ",e(n.code,{children:"depth"}),"가 크도록 ",e(n.code,{children:"swap"}),"을 하는 것이 편하다. 이렇게 구현하면 2중포문이 없기 때문에 ",e(n.code,{children:"worst"}),"는 ",e(n.code,{children:"O(n)"}),"이다."]}),`
...
`})}),`
`,r(n.p,{children:["새로운 값이 추가될 때, 위와 같이 ",e(n.code,{children:"Node"}),"를 업데이트 하면 된다."]}),`
`,e(p,{}),`
