import{p as t}from"./Basic_-3076d7c8.js";import{u as r,j as e,a as i,F as h}from"./ssg-client-53b59081.js";import{C as o}from"./Comment-7df84669.js";import"./index.module-caf545e8.js";import{H as s}from"./Header-324a32b7.js";import"./katex.min-4ed993c7.js";function d(l){const n=Object.assign({h2:"h2",p:"p",ul:"ul",li:"li",code:"code",ol:"ol",pre:"pre"},r(),l.components);return i(h,{children:[e(s,{}),`
`,e(n.h2,{id:"graph-basic",children:"Graph Basic"}),`
...
`,i(n.li,{children:[`
`,e(n.p,{children:"BFS"}),`
`,i(n.p,{children:["노드 ",e(n.code,{children:"x"}),"로부터 각 노드까지 걸리는 거리를 구한다고 해보자. 잘 안쓰이는 방식이긴 하지만(구현이 dfs보다 복잡해서) 아래처럼도 가능하다."]}),`
`]}),`
`]}),`
...
`})}),`
`,e(o,{})]})}function a(l={}){const{wrapper:n}=Object.assign({},r(),l.components);return n?e(n,Object.assign({},l,{children:e(d,l)})):d(l)}const u=Object.freeze(Object.defineProperty({__proto__:null,default:a},Symbol.toStringTag,{value:"Module"})),c={};c.outlineInfo=t;c.main=u;export{c as default};
