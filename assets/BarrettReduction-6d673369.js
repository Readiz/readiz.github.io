import{p as o}from"./BarrettReduction_-2a6a747c.js";import{u as t,j as e,a as l,F as c}from"./ssg-client-952ad180.js";import{C as d}from"./Comment-18265265.js";import{H as m}from"./Header-064a4e9a.js";import{T as s}from"./TagList-3fd7562e.js";import"./index.module-caf545e8.js";function a(r){const n=Object.assign({h2:"h2",p:"p",code:"code",pre:"pre",h3:"h3",ul:"ul",li:"li",a:"a"},t(),r.components);return l(c,{children:[e(m,{}),`
`,e(n.h2,{id:"barrett-reduction",children:"Barrett Reduction"}),`
`,l(n.p,{children:["조각코드 저장용으로 만든 페이지이다. ",e(n.code,{children:"Assembly Level"}),"에서 가장 느린 Arithmetic 연산을 꼽으라고 한다면, ",e(n.code,{children:"modular"})," 연산일 것이다. 보통 PS에서는 나눗셈 연산이 소수값이 나오지 않도록 하기 위해서 modular 연산을 한 값을 출력하도록 하는 경우가 많은데, 이 경우 일단 modular 연산 자체를 줄이는게 첫번째고, 도저히 안될 경우 차선책으로 사용할 수 있는 방법이다."]}),`
