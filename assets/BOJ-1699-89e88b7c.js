import{p as c}from"./BOJ-1699_-d96fd751.js";import{u as l,j as e,a as s,F as m}from"./ssg-client-d8362002.js";import{C as r}from"./Comment-f2c1aa08.js";import{H as h}from"./Header-845f5326.js";import{T as d}from"./TagList-79e706df.js";import"./katex.min-4ed993c7.js";import"./index.module-caf545e8.js";function i(a){const n=Object.assign({ul:"ul",li:"li",a:"a",p:"p",h2:"h2",span:"span",math:"math",semantics:"semantics",mrow:"mrow",mi:"mi",mo:"mo",mn:"mn",annotation:"annotation",msup:"msup",code:"code",msqrt:"msqrt",svg:"svg",path:"path",h3:"h3",pre:"pre"},l(),a.components);return s(m,{children:[e(h,{}),`
`,s(n.ul,{children:[`
...
`]}),`
`,e(n.p,{children:"오랜만에 tag: DP로 검색해서 풀어본 문제. DP 문제는 실버까지는 굉장히 재미있다. 골드부터는 관찰이 좀 어려워서져서 풀이가 힘들지만.. PS의 빈출 영역이기 때문에 꾸준히 연습해야 한다."}),`
