import{p as a}from"./Bitcnt_-94819c75.js";import{r as F,a as e,F as r,j as i,u as d}from"./ssg-client-489be581.js";import{C as h}from"./Comment-b59df6ea.js";import{H as v}from"./Header-16833879.js";const p=t=>{const[n,s]=F.useState(!1);function o(){s(!n)}return e(r,{children:[i("div",{onClick:o,style:{fontWeight:700,cursor:"pointer"},children:n?"👆 닫기":"👉 펼치기"}),i("div",{style:{display:n?"block":"none"},children:t.children})]})};function c(t){const n=Object.assign({p:"p",code:"code",pre:"pre",h3:"h3",a:"a",h2:"h2"},d(),t.components);return e(r,{children:[i(v,{}),`
...
`,e(p,{children:[i(n.h3,{id:"32bit-test",children:"32bit Test"}),i(n.pre,{children:i(n.code,{className:"language-cpp",children:`#include <stdio.h>
#include <time.h>
...
`})})]}),`
`,i(h,{})]})}function u(t={}){const{wrapper:n}=Object.assign({},d(),t.components);return n?i(n,Object.assign({},t,{children:i(c,t)})):c(t)}const g=Object.freeze(Object.defineProperty({__proto__:null,default:u},Symbol.toStringTag,{value:"Module"})),l={};l.outlineInfo=a;l.main=g;export{l as default};
