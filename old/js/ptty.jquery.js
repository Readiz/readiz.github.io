    ...
    $.fn.Ptty = function(options) {
        ...
        * */
        ...
        this.each( function() {
            ...
            **/
            public.native_commands = function(){
            ...
            * @desc     : Registers the native Ptty commands
            **/
            public.native_responses = function(cmd_opts){
            ...
            **/
            public.run_command = function(command, mute){
                quiet = mute;
                cmd_start(command);
            }
            ...
            **/
            public.echo = function(out_str, no_scroll){
                if(out_str){
                    el.find('.content')
            ...
            **/
            public.change_settings = function(settings_obj){
            ...
            **/
            public.unregister = function(method_type, method_name){
                var flag = false;
            ...
            **/
            public.register = function(method_type, obj){
                var ret = false;
                if(obj){
                    method_name = (obj.hasOwnProperty('name')) ? obj.name : false,
            ...
            **/
            public.set_command_option = function(option_obj){
            ...
            **/
            public.get_command_option = function(options_mix){
                var out;
            ...
            **/
            public.tokenize = function(command, options_arr){
                var out = {};
                ...
                if(typeof cmd[0] === 'undefined' || cmd[0] === ''){
                    ...
                    var first_char = last_char = before_last = false;
            ...
            if(settings.native_cmds){
                public.native_commands();    
            }
            public.native_responses(cmd_opts);
